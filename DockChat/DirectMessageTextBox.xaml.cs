...
namespace DockChat
{
    public partial class DirectMessageTextBox : UserControl   //, INotifyPropertyChanged
    {
        ...
        public DirectMessageTextBox()
        {
            this.InitializeComponent();
        }

        public DirectMessageTextBox(DirectMessage message)
        {
            
        }

        public DirectMessageTextBox(DirectMessage message, Color backgroundColor)
        {
            this.InitializeComponent();
